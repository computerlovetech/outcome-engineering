...
<div class="page">
	...
	<p class="muted">
		Outcome Graphs that humans and agents can trace and update: vision, strategy, ICPs, jobs,
		outcomes, opportunities, solutions, and the flywheel that connects them.
	</p>
	{#if checking}
